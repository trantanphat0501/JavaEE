...
public class DukesBirthdayBean {
    ...
    //Business Method to DukesBirthdayBean that Gets the Average Age Difference of firstcup-war Users
    ...
    //Business Method for Calculating the Age Difference Between Duke and the User
